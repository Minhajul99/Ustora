                        ...
                        <div class="col-sm-6">
                            <div class="product-images">
                                <div class="product-main-img">
                                     <img src="{{asset('backend/productimgages/'.$singleproduct->image)}}" alt="">
                                </div>
                        ...
                        <div class="col-sm-6">
                            <div class="product-inner">
                                ...
                                <div class="product-inner-price">
                                    <ins>$500.00</ins> <del>$1000.00</del>
                                </div>
                                ...
                                <div class="product-inner-category">
                                    <h4>Category: <a href="">{{$singleproduct->category_name}}</a>.</h4>
                                    <h4> Brand: <a href="">{{$singleproduct->brand_name}}</a></h4>
                                </div>
