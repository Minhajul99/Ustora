                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        name="brand_name" id="brand_name" value="{{ old('brand_name') }}">
                                                        <span class="text-danger">
                                                            @error('brand_name')
                                                                {{ $message }}
                                                            @enderror
                                                ...
                                                <div class="col-md-6">
                                                  ...
                                                  <div class="form-group">
                                                    ...
                                                    <textarea type="text" placeholder="Enter Product Description" class="des form-control" rows="4" name="description" ></textarea>
